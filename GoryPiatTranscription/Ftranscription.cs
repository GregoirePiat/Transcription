...
namespace GoryPiatTranscription
{
    public partial class Ftranscription : Form
    {
        ...
        {
            //Dictionary<int, int> transpo = Transcription.computeTranspoSequence("ISTIL");
                Dictionary<int, String> tab = Transcription.computeTab("L’ISTIL DEVIENT UNE ECOLE POLYTECHNIQUE ", "ISTIL");
